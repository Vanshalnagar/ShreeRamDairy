...
async function startScraping() {
  try {
    ...
    for (let i = 0; i < products.length; i++) {
      ...
      // Skip products that already look like they have a customized scraped image (i.e. not the default unsplash URLs)
      // The default seeder unsplash URLs:
      ...
      // - https://images.unsplash.com/photo-1589119908995-c6837fa14848
      ...
      // Throttle requests by 1 second to be polite to search engine
      await sleep(1000);
    }
